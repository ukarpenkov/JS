...
// var sexSelect = document.getElementById('male')
// var yourStatus = document.getElementById('alone')
// var cityChoose = document.getElementById("city");
// var cityMsk = document.getElementById("msk");
// var myHobby = document.getElementById("list-about");
// let mullen = document.getElementById("mullen");

let Fio = document.getElementsByClassName('default-input')

let choose = document.getElementsByClassName('choose')

let goButton = document.getElementById('send')
goButton.addEventListener('click', function(){
choose[0].checked = true
choose[2].checked = true
choose[3].value = 'minsk'
Fio[0].value = 'PeRRR'
Fio[1].value = 'решаррр'
mullen.src = 'https://xakep.ru/wp-content/uploads/2019/02/207666/ghost-h.jpg'
})
...
// setTimeout(function(){
//   firstNameEl.value = 'Ura'
// lastNameEl.value = 'Karpenkov'
// sexSelect.checked = true
// yourStatus.checked = true
// cityChoose.value = 'msk'
// mullen.src = 'https://xakep.ru/wp-content/uploads/2019/02/207666/ghost-h.jpg'
// myHobby.value = 'hello'
// }, 2000);
