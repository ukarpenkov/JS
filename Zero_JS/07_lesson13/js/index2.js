...
function getEl (id){
  console.log('smbd wants find el by id');
...
var address = getEl("address");

var cityChoose = getEl("city");
var cityMsk = getEl("msk");
var myHobby = getEl("hobby");
alertValues(myHobby)
var pic = getEl("pic");
let mullen = getEl("mullen");
